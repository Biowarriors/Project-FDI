...
FDI_SP_L2_dataset_1_disjoint <- read.csv("My Doc/new_link_prediction_SP_L2_dataset_1_disjoint_FDI.csv", header = TRUE)
...
# 
# FDI_SP_L2_dataset_2_joint <- read.csv("My Doc/new_link_prediction_SP_L2_dataset_2_joint_FDI.csv", header = TRUE)
...
FDI_NB_AA_dataset_2_joint <- read.csv("My Doc/new_link_prediction_NB_AA_dataset_2_joint_FDI.csv", header = TRUE, stringsAsFactors = FALSE)
FDI_NB_AA_dataset_2_joint = FDI_NB_AA_dataset_2_joint %>% 
  mutate(col1 = pmin(from, to), col2 = pmax(from, to), 
           id = paste(col1, col2, sep="__")) %>% 
             separate(id, into=c("from", "to"), sep="__")
...
FDI_NB_AA_dataset_2_joint_new_unique_food_ID_top_10 <- FDI_NB_AA_dataset_2_joint_new_unique_food_ID[1:10, c("from", 
                                                                                                            "foodID_CompoundID_Compound_Name", 
                                                                                                            "value")]
...
FDI_NB_CN_dataset_2_joint <- read.csv("My Doc/new_link_prediction_NB_CN_dataset_2_joint_FDI.csv", header = TRUE, stringsAsFactors = FALSE)
...
FDI_NB_CN_dataset_2_joint_new_unique_food_ID_top_10 <- FDI_NB_CN_dataset_2_joint_new_unique_food_ID[1:10, c("food_ID", 
                                                                                                            "foodID_CompoundID_Compound_Name", 
                                                                                                            "value")]
...
FDI_NB_L3_dataset_2_joint <- read.csv("My Doc/new_link_prediction_NB_L3_dataset_2_joint_FDI.csv", header = TRUE, stringsAsFactors = FALSE)
...
FDI_NB_L3_dataset_2_joint_new_unique_food_ID_top_10 <- FDI_NB_L3_dataset_2_joint_new_unique_food_ID[1:10, c("food_ID", 
                                                                                                            "foodID_CompoundID_Compound_Name", 
                                                                                                            "value")]
...
FDI_NB_RA_dataset_2_joint <- read.csv("My Doc/new_link_prediction_NB_RA_dataset_2_joint_FDI.csv", header = TRUE, stringsAsFactors = FALSE)
...
FDI_NB_RA_dataset_2_joint_new_unique_food_ID_top_10 <- FDI_NB_RA_dataset_2_joint_new_unique_food_ID[1:10, c("food_ID", 
                                                                                                            "foodID_CompoundID_Compound_Name", 
                                                                                                            "value")]
...
write.csv(finalCSV, "My Doc/Top_10_FDI_All_Methods_Batch_1.csv", row.names = FALSE)
