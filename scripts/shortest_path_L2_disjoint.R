...
write.table(df_ddi_fdi_ffi_info_sp_algo, "My Doc/Final_Calculation_Information_SP_dataset_1_disjoint.csv", row.names = FALSE, col.names = FALSE, sep=",") 
...
shortest_path_final_model_l2 <- function(main_dataset_for_shortest_path_algo) {
  ...
  write.csv(output, "My Doc/new_link_prediction_SP_L2_dataset_1_disjoint.csv", row.names = FALSE) 
  ...
  all_data_ddi_fdi_ffi_info_sp_algo <- read.csv("My Doc/new_link_prediction_SP_L2_dataset_1_disjoint.csv", header = TRUE)
  ...
  write.csv(all_ddi, "My Doc/new_link_prediction_SP_L2_dataset_1_disjoint_DDI.csv", row.names = FALSE) 
  ...
  write.csv(df_remove_ff, "My Doc/new_link_prediction_SP_L2_dataset_1_disjoint_FDI.csv", row.names = FALSE) 
  ...
  df_ddi_fdi_ffi_info_sp_algo <-  read.csv("My Doc/Final_Calculation_Information_SP_dataset_1_disjoint.csv")
  
  df_ddi_fdi_ffi_info_sp_algo <- rbind(df_ddi_fdi_ffi_info_sp_algo, temp_df_ddi_fdi_ffi_info_sp_algo) 
  
  write.csv(df_ddi_fdi_ffi_info_sp_algo, "My Doc/Final_Calculation_Information_SP_dataset_1_disjoint.csv", row.names = FALSE) 
  
}

# Training the dataset using shortest path
train_dataset_for_shortest_path <- read.csv("My Doc/dataset_1_disjoint.csv", header = TRUE)
