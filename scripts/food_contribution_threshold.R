...
df_1 <- read.csv("My Doc/food_contribution.csv", header = TRUE)
print(nrow(df_1))
df_2 <- read.csv("My Doc/threshold.csv", header = TRUE)
print(nrow(df_2))
...
write.csv(df_remove, "My Doc/dataset_1_disjoint.csv", row.names = FALSE)  
